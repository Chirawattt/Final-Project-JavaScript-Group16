    ...
    static {
        ...
        lessonData.put(1, new String[]{
                ...
                "<h1><span style='color:#F7DF1E'>ข้อมูลพื้นฐานเกี่ยวกับชนิดข้อมูล (Data Types)</span></h1>"
                        ...
                        + "<h1><span style='color:#F7DF1E'>ความแตกต่างระหว่างชนิดข้อมูลแต่ละประเภท</span></h1>"
                        ...
                        + "<h1><span style='color:#F7DF1E'>อ็อบเจกต์ (Object) และอาร์เรย์ (Array)</span></h1>"
        ...
        lessonExamples.put(1, new String[]{
                ...
                "<span style='color:#555555'>// ค่าว่าง (Null)</span> <br>let emptyValue = null; <br>console.log(emptyValue);",
                "<span style='color:#555555'>// ค่าที่ยังไม่ได้กำหนด (Undefined)</span> <br>let notDefined; <br>console.log(notDefined);",
        ...
        lessonData.put(2, new String[]{
                ...
                "<h1><span style='color:#F7DF1E'>ตัวแปรคืออะไร?</span></h1>"
                        ...
                        + "• <b>`const`</b> - ตัวแปรค่าคงที่ เปลี่ยนค่าไม่ได้<br><br>"
                        ...
                        + "• <b>`const`</b> - ต้องกำหนดค่าเริ่มต้น และ <b>เปลี่ยนค่าไม่ได้</b><br><br>"
        ...
        lessonData.put(3, new String[] {
                ...
                "<h1><span style='color:#F7DF1E'>ตัวดำเนินการทางคณิตศาสตร์ (Arithmetic Operators)</span></h1>"
                        ...
                        + "<span style='color:#F7DF1E'><b>💡 Tips:</b></span> ถ้าหารด้วย 0 ใน <b>JavaScript</b> จะได้ค่าเป็น <code>Infinity</code> เช่น <code>10 / 0</code> จะได้ <code>Infinity</code><br><br>"
                        ...
                        + "<span style='color:#F7DF1E'><b>💡 Tips:</b></span> ใช้ `===` แทน `==` เพื่อป้องกันข้อผิดพลาดจากการเปรียบเทียบที่ไม่ชัดเจน (Type Coercion)<br><br>"
                        ...
                        + "• <span style='color:#F7DF1E'><b>!</b> (NOT)</span> - ใช้กลับค่าความจริง เช่น <code>!true</code> ได้ <code>false</code><br><br>"
                        ...
                        + "• <span style='color:#F7DF1E'><b>+=</b>, <b>-=</b>, <b>*=</b>, <b>/=</b></span> - ใช้อัปเดตค่า เช่น <code>x += 5;</code> แทน <code>x = x + 5;</code><br><br>"
        ...
        lessonExamples.put(3, new String[]{
                ...
                "<span style='color:#555555'>// ตัวดำเนินการกำหนดค่า</span> <br>let a = 5; <br>a *= 2; <br>console.log(a);",
        ...
        lessonData.put(4, new String[]{
                ...
                "<h1><span style='color:#F7DF1E'>คำสั่งเลือกทำ (Conditional Statements)</span></h1>"
                        ...
                        + "<h1><span style='color:#F7DF1E'>คำสั่งวนซ้ำ (Looping Statements)</span></h1>"
                        + "ใช้สำหรับทำซ้ำคำสั่งเดิมหลายครั้งจนกว่าเงื่อนไขจะเป็น `false`<br><br>"

                        + "<span style='color:#F7DF1E'><b>คำสั่ง for</b></span><br>"
                        + "• ใช้ในกรณีที่รู้จำนวนรอบแน่นอน เช่น วนลูปจาก 1 ถึง 10<br><br>"

                        + "<span style='color:#F7DF1E'><b>คำสั่ง while และ do...while</b></span><br>"
                        ...
                        + "<h1><span style='color:#F7DF1E'>คำสั่งควบคุมการทำงานของลูป (Loop Control Statements)</span></h1>"
                        + "ใช้เพื่อควบคุมการทำงานของลูปโดยเฉพาะ<br><br>"

                        + "<span style='color:#F7DF1E'><b>คำสั่ง break</b></span><br>"
                        + "• ใช้เพื่อหยุดการทำงานของลูปทันทีเมื่อเข้าเงื่อนไข<br><br>"

                        + "<span style='color:#F7DF1E'><b>คำสั่ง continue</b></span><br>"
                        + "• ใช้เพื่อข้ามการทำงานของรอบปัจจุบัน แล้วไปทำรอบถัดไปแทน<br><br>"

                        + "<font color='#F7DF1E'>━━━━━━━━━━━━━━━━━━</font><br>"

                        + "<h1><span style='color:#F7DF1E'>การจัดการข้อผิดพลาด (Error Handling)</span></h1>"
                        + "ใช้เพื่อป้องกันโปรแกรมหยุดทำงานเมื่อเกิดข้อผิดพลาด<br><br>"

                        + "<span style='color:#F7DF1E'><b>คำสั่ง try...catch</b></span><br>"
        ...
        lessonExamples.put(4, new String[]{
                ...
                "<span style='color:#555555'>// คำสั่ง while</span> <br>let x = 0;<br>while (x < 3) {<br>  \t\tconsole.log('x = ' + x);<br>  \t\tx++;<br>}",
        ...
        lessonData.put(5, new String[]{
                ...
                "<h1><span style='color:#F7DF1E'>ความหมายและประโยชน์ของฟังก์ชัน</span></h1>"
                        + "ฟังก์ชันใน JavaScript เป็นโครงสร้างสำคัญที่ช่วยให้การพัฒนาโปรแกรมมีความยืดหยุ่นและมีประสิทธิภาพ<br><br>"
                        + "<span style='color:#F7DF1E'><b>ประโยชน์ของฟังก์ชัน</b></span><br>"
                        ...
                        + "<span style='color:#F7DF1E'><b>💡 Tips:</b></span> ใช้ฟังก์ชันเพื่อแบ่งโค้ดเป็นส่วนเล็ก ๆ ตามหน้าที่ เช่น `calculateTotal()`, `getUserInfo()` เพื่อให้โค้ดอ่านง่ายขึ้น<br><br>"

                        + "<font color='#F7DF1E'>━━━━━━━━━━━━━━━━━━</font><br>"

                        + "<h1><span style='color:#F7DF1E'>การประกาศฟังก์ชัน (`function` keyword)</span></h1>"
                        + "JavaScript รองรับการประกาศฟังก์ชันโดยใช้คำสั่ง `function` ตามด้วยชื่อฟังก์ชัน และวงเล็บ `()`<br><br>"
                        + "<span style='color:#F7DF1E'><b>โครงสร้างของฟังก์ชัน</b></span><br>"
                        + "function ชื่อฟังก์ชัน(พารามิเตอร์) {<br>  \t\t// คำสั่งที่ต้องการให้ฟังก์ชันทำงา<br>}<br><br>"
                        ...
                        + "<span style='color:#F7DF1E'><b>💡 Tips:</b></span> ใช้ชื่อฟังก์ชันที่สื่อความหมาย และควรใช้ <b>verb + noun</b> เช่น `getData()`, `calculateSum()` เพื่อให้โค้ดเข้าใจง่าย<br><br>"

                        + "<font color='#F7DF1E'>━━━━━━━━━━━━━━━━━━</font><br>"

                        + "<h1><span style='color:#F7DF1E'>การเรียกใช้ฟังก์ชัน</span></h1>"
                        + "หลังจากที่สร้างฟังก์ชันแล้ว จะต้องเรียกใช้โดยพิมพ์ชื่อฟังก์ชันตามด้วยวงเล็บ `()`<br><br>"
                        + "<span style='color:#F7DF1E'><b>ตัวอย่าง</b></span><br>"
                        + "function sayHello() {<br>  \t\tconsole.log('Hello!');<br>}<br>sayHello();<br><br>"
                        + "• ฟังก์ชันจะทำงานก็ต่อเมื่อถูกเรียกใช้เท่านั้น ไม่ทำงานอัตโนมัติเมื่อประกาศเสร็จ<br><br>"
                        + "<span style='color:#F7DF1E'><b>💡 Tips:</b></span> หลีกเลี่ยงการเรียกใช้ฟังก์ชันที่ยังไม่ได้ประกาศ (Hoisting อาจทำให้เกิดข้อผิดพลาดได้) ควรประกาศฟังก์ชันก่อนใช้งานเสมอ<br><br>"

                        + "<font color='#F7DF1E'>━━━━━━━━━━━━━━━━━━</font><br>"

                        + "<h1><span style='color:#F7DF1E'>พารามิเตอร์ (Parameters) และอาร์กิวเมนต์ (Arguments)</span></h1>"
                        ...
                        + "<span style='color:#F7DF1E'><b>ตัวอย่าง</b></span><br>"
                        + "function greet(name) {<br>  \t\tconsole.log('สวัสดี ' + name);<br>}<br>greet('Alice');<br><br>"
                        + "<span style='color:#F7DF1E'><b>💡 Tips:</b></span> กำหนดค่าเริ่มต้นให้กับพารามิเตอร์ เช่น `function greet(name = 'Guest')` เพื่อป้องกันค่าที่ไม่ได้ส่งมา<br><br>"

                        + "<font color='#F7DF1E'>━━━━━━━━━━━━━━━━━━</font><br>"

                        + "<h1><span style='color:#F7DF1E'>ค่าที่ฟังก์ชันส่งกลับ (Return Values)</span></h1>"
                        + "สามารถใช้ `return` เพื่อส่งค่ากลับจากฟังก์ชัน<br><br>"
                        + "<span style='color:#F7DF1E'><b>ตัวอย่าง</b></span><br>"
                        + "function add(a, b) {<br>  \t\treturn a + b;<br>}<br>let result = add(5, 10);<br>console.log(result);<br><br>"
                        + "<span style='color:#F7DF1E'><b>💡 Tips:</b></span> ฟังก์ชันควรทำงานให้สั้นและมีหน้าที่เดียว (Single Responsibility Principle) เพื่อให้ง่ายต่อการจัดการ<br><br>"

                        + "<font color='#F7DF1E'>━━━━━━━━━━━━━━━━━━</font><br>"

                        + "<h1><span style='color:#F7DF1E'>ฟังก์ชันนิรนาม (Anonymous Functions)</span></h1>"
                        + "ฟังก์ชันที่ไม่มีชื่อ และสามารถเก็บไว้ในตัวแปรเพื่อเรียกใช้ภายหลังได้<br><br>"
                        + "<span style='color:#F7DF1E'><b>ตัวอย่าง</b></span><br>"
                        + "const multiply = function(a, b) {<br>  \t\treturn a * b;<br>};<br>console.log(multiply(4, 3));<br><br>"
                        + "<span style='color:#F7DF1E'><b>💡 Tips:</b></span> ใช้ฟังก์ชันนิรนามเมื่อฟังก์ชันไม่มีความจำเป็นต้องใช้ชื่อ เช่น callback function หรือ event handler<br><br><br>"

                        + "<font color='#F7DF1E'>━━━━━━━━━━━━━━━━━━</font><br>"

                        + "<h1><span style='color:#F7DF1E'>ฟังก์ชันลูกศร (Arrow Functions)</span></h1>"
                        + "ฟังก์ชันแบบย่อ ใช้ `=>` แทน `function` เพื่อทำให้โค้ดกระชับขึ้น<br><br>"
                        + "<span style='color:#F7DF1E'><b>ตัวอย่าง</b></span><br>"
                        + "const square = x => x * x;<br>console.log(square(5));</code><br><br>"
                        + "<span style='color:#F7DF1E'><b>💡 Tips:</b></span> ใช้ฟังก์ชันลูกศรเมื่อไม่ต้องการ `this` เช่น callback function หรือ map/filter/reduce<br><br>"

                        + "<font color='#F7DF1E'>━━━━━━━━━━━━━━━━━━</font><br>"

                        + "<h1><span style='color:#F7DF1E'>ฟังก์ชันเรียกตัวเอง (Recursive Functions)</span></h1>"
                        + "ฟังก์ชันที่เรียกใช้ตัวเอง เหมาะสำหรับการคำนวณเชิงซ้ำ เช่น แฟกทอเรียล (Factorial)<br><br>"
                        + "<span style='color:#F7DF1E'><b>ตัวอย่าง</b></span><br>"
                        + "function factorial(n) {<br>  \t\tif (n === 1) return 1;<br>  \t\treturn n * factorial(n - 1);<br>}<br>console.log(factorial(5));<br><br>"
                        + "<span style='color:#F7DF1E'><b>💡 Tips:</b></span> ใช้เงื่อนไขหยุด (`base case`) เสมอ เพื่อป้องกันลูปที่ไม่มีที่สิ้นสุดใน recursive function<br><br>"

                        + "<font color='#F7DF1E'>━━━━━━━━━━━━━━━━━━</font><br>"

                        + "<h1><span style='color:#F7DF1E'>การจัดการขอบเขตของ `this` ภายในฟังก์ชัน</span></h1>"
                        + "ค่าของ `this` ขึ้นอยู่กับวิธีที่ฟังก์ชันถูกเรียกใช้<br><br>"
                        + "<span style='color:#F7DF1E'><b>ตัวอย่าง</b></span><br>"
                        + "const person = {<br>  \t\tname: 'John',<br>  \t\tgreet: function() {<br>    \t\t\t\tconsole.log('Hello, ' + this.name);<br>  \t\t}<br>};<br>person.greet();<br><br>"
        ...
        lessonExamples.put(5, new String[]{
                ...
                "<span style='color:#555555'>// ฟังก์ชันลูกศร</span> <br>const multiply = (x, y) => x * y;<br>console.log(multiply(4, 6));",
